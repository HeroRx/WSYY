...
public class SelectedDoctorDetailActivity extends AppCompatActivity {
...
//        initAppBarLayout();
    ...
    public void getDDetail(){
        ...
        String bdid = intent.getStringExtra("mbdname");
...
//        query.setCachePolicy(BmobQuery.CachePolicy.CACHE_ELSE_NETWORK);
    ...
    public void setRv(){
        LinearLayoutManager layoutManager = new LinearLayoutManager(SelectedDoctorDetailActivity.this);
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        final WeekDayAdapter weekDayAdapter;
        weekDayAdapter = new WeekDayAdapter(SelectedDoctorDetailActivity.this,timelist,haolist);
