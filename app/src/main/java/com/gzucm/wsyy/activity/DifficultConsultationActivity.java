...
public class DifficultConsultationActivity extends AppCompatActivity {
    @BindView(R.id.dc_toolbar)
    Toolbar tb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_difficultconsultation);
    ...
    private void setLeftName() {
        ...
        new GetDepartmentUtil().getBD().subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<List<BigDepartment>>() {
            ...
            public void onNext(List<BigDepartment> bigDepartments) {
                ...
                Log.i("数据",bdids + "");
                LinearLayoutManager layoutManager = new LinearLayoutManager(DifficultConsultationActivity.this);
                layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
                leftrv.setLayoutManager(layoutManager);
                leftAdapter = new MostLeftAdapter(DifficultConsultationActivity.this,bdnames);
    ...
    private void setRightData(final int i) {
        ...
        new GetDepartmentUtil().getD(bdids.get(i)).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<List<Department>>() {
            ...
            public void onNext(List<Department> departments) {
                ...
                Log.i("数据",dnames + "");
                Log.i("数据",dids + "");
                LinearLayoutManager layoutManager1 = new LinearLayoutManager(DifficultConsultationActivity.this);
                layoutManager1.setOrientation(LinearLayoutManager.VERTICAL);
                rightrv.setLayoutManager(layoutManager1);
                rightAdapter = new MostRightAdapter(DifficultConsultationActivity.this,dnames);
...
//                rightAdapter.notifyDataSetChanged();
                ...
                rightAdapter.setOnItemClickListener(new MostRightAdapter.MyItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        //跳转到星期选择界面
                        Intent intent = new Intent(DifficultConsultationActivity.this,DifficultAppointmentActivity.class);
                        intent.putExtra("dname",dnames.get(position));
