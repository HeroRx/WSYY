...
public class SelectedTDuanActivity extends AppCompatActivity{
    ...
    public void left(){
        ...
        if(index == 1){
            ...
            if(index == 0){
                Toast.makeText(SelectedTDuanActivity.this,"请您选择其他日期",Toast.LENGTH_SHORT).show();
    ...
    public void setData(){
        ...
        final String name = mDoctor.getD_name();
        final String title = mDoctor.getD_titles();
        final String url = mDoctor.getD_photo().getFileUrl();
        tdname.setText(name);
    ...
    public void setDName(){
        ...
        final String id = mDoctor.getD_dcode().getObjectId();
...
//        query.setCachePolicy(BmobQuery.CachePolicy.CACHE_ELSE_NETWORK);
    ...
    public void getDay(String day) {
        ...
        final String did = mDoctor.getObjectId();
        switch (day){
            case "周一":
                setMon(did);
                break;
    ...
    public void setRv(){
        setDName();
        LinearLayoutManager layoutManager = new LinearLayoutManager(SelectedTDuanActivity.this);
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        TimeDuanAdapter timeDuanAdapter;
        timeDuanAdapter = new TimeDuanAdapter(SelectedTDuanActivity.this,urlList,moneyList,countList);
        ...
        timeDuanAdapter.setOnItemClickListener(new TimeDuanAdapter.MyItemClickListener(){
            ...
            public void onItemClick(View view, int postion) {
                Intent intent = new Intent(SelectedTDuanActivity.this,SelectPatientActivity.class);
                setData();
